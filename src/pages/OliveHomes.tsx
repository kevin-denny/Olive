...
import { Home, Palette, Sofa, Utensils, ArrowRight, Star, Send } from 'lucide-react';
  ...
  const categories = [
    {
      ...
      description: 'Elegant sofas, coffee tables, and entertainment units that define comfort and style.',
      icon: Sofa,
      image: 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=800',
      products: ['Sectional Sofas', 'Coffee Tables', 'Entertainment Centers', 'Accent Chairs']
    },
    {
      title: 'Kitchen Essentials',
      description: 'Premium cookware, dinnerware, and kitchen accessories for the modern home.',
      icon: Utensils,
      image: 'https://images.pexels.com/photos/1599791/pexels-photo-1599791.jpeg?auto=compress&cs=tinysrgb&w=800',
      products: ['Cookware Sets', 'Dinnerware', 'Kitchen Accessories', 'Storage Solutions']
    },
    {
      title: 'Home Decor',
      description: 'Curated decorative pieces, lighting, and accessories to personalize your space.',
      icon: Palette,
  ...
  return (
    ...
    >
      ...
      <section className="py-20" style={{ backgroundColor: colors.light }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Thoughtfully curated products for every room in your home</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Lifestyle Inspirations</h2>
            <p className="text-xl text-gray-600">Discover your perfect aesthetic and create spaces that inspire</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Request Our Catalog</h2>
            <p className="text-xl text-gray-600">
              Get exclusive access to our complete homeware collection and latest lifestyle inspirations
            </p>
          </div>
