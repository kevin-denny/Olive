...
import { Cog, Wrench, ChefHat, Download, Award, Users, Target } from 'lucide-react';

const OliveMarketing = () => {
  const categories = [
    {
      title: 'Industrial Machinery',
      description: 'High-performance machinery for manufacturing and industrial applications.',
      icon: Cog,
      image: 'https://images.pexels.com/photos/416405/pexels-photo-416405.jpeg?auto=compress&cs=tinysrgb&w=800',
      products: ['Manufacturing Equipment', 'Assembly Lines', 'Quality Control Systems', 'Automation Solutions']
    },
    {
      ...
      products: ['Hand Tools', 'Power Tools', 'Measuring Instruments', 'Cutting Tools']
    },
    {
      title: 'Industrial Cookware',
      description: 'Commercial-grade cookware solutions for professional kitchens.',
      icon: ChefHat,
      image: 'https://images.pexels.com/photos/4252143/pexels-photo-4252143.jpeg?auto=compress&cs=tinysrgb&w=800',
      products: ['Commercial Cookware', 'Kitchen Equipment', 'Food Preparation Tools', 'Storage Solutions']
    }
  ];
  ...
  const caseStudies = [
    {
      ...
      description: 'Implemented automated assembly line solutions that transformed their manufacturing process.'
    },
    {
      ...
      description: 'Provided comprehensive kitchen equipment for rapid restaurant chain expansion.'
    },
    {
      ...
      description: 'Supplied high-precision tools that significantly improved manufacturing accuracy.'
    }
  ];
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Comprehensive solutions for industrial and commercial needs</p>
          </div>
            ...
            {caseStudies.map((study, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-green-600 font-semibold mb-2">{study.client}</p>
      ...
      <section className="py-20 bg-green-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-green-100">Delivering measurable results across industries</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-12">
            Connect with our industrial solutions experts to discuss your specific requirements and discover how we can help optimize your business operations.
          </p>
